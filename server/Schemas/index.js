    ...
    signin: {
      ...
      async resolve(parent, args) {
        try {
          ...
          console.log(
            `Successfully called the user with email:${args.email} from MongoDB`
          );
          ...
          throw new Error(
            `Error fetching user with emails: ${args.email}: ${error.message}`
          );
        }
      },
    },
    ...
    getUserByNameDB: {
      ...
      async resolve(parent, args) {
        try {
          ...
          throw new Error(
            `Error fetching user by ${args.name}: ${error.message}`
          );
        }
      },
    },
